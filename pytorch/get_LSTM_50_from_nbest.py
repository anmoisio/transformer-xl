...
# This script rescores nbest lists
...
def choose_hypotheses(hyps, lowest_costs,ac_costs):
    nf=open('/scratch/work/moisioa3/conv_lm/transformer-xl/data/rescored/lstm/50_best_hyp','w')
    af=open('/scratch/work/moisioa3/conv_lm/transformer-xl/data/rescored/lstm/50_best_acw','w')
