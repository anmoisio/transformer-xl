...
results () {
  ...
  /scratch/work/moisioa3/conv_lm/scripts/score.sh ${test_set} ${gen_dir}/hypoth_text-${model}_lms{8,9,10,11,12}-${n}best-combined.txt > results-${model}-${test_set}-${n}best.txt
}
